...
def deploy() -> None:
    ...
    env_vars = {
        "Variables": {
            ...
            "BEDROCK_SEARCH_TYPE": values.get("BEDROCK_SEARCH_TYPE", ""),
            "BEDROCK_RERANK_MODEL_ARN": values.get("BEDROCK_RERANK_MODEL_ARN", ""),
            "BEDROCK_RERANK_FINAL_COUNT": str(values.get("BEDROCK_RERANK_FINAL_COUNT", "")),
            "BEDROCK_RERANK_OVERFETCH_COUNT": str(values.get("BEDROCK_RERANK_OVERFETCH_COUNT", "")),
            "BEDROCK_QUERY_REWRITE_COUNT": str(values.get("BEDROCK_QUERY_REWRITE_COUNT", "")),
            "BEDROCK_QUERY_REWRITE_MODEL_ID": values.get("BEDROCK_QUERY_REWRITE_MODEL_ID", ""),
