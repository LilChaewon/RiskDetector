"""Build a Lambda deployment zip for detector_ocr_lambda."""
...
ZIP_PATH = DIST_DIR / "detector_ocr_lambda.zip"

PACKAGE_FILES = [
    (BACKEND_AI_DIR / "lambdas" / "__init__.py", "lambdas/__init__.py"),
    (BACKEND_AI_DIR / "lambdas" / "ocr_lambda" / "__init__.py", "lambdas/ocr_lambda/__init__.py"),
    (BACKEND_AI_DIR / "lambdas" / "ocr_lambda" / "handler.py", "lambdas/ocr_lambda/handler.py"),
]
